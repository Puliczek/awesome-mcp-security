...
- (01.03.2026) [MolTrust MCP Server by MoltyCel](https://github.com/MoltyCel/moltrust-mcp-server) 🐍 🏠 ☁️ - Agent identity, trust, and security toolkit — DID creation, trust scoring, credential verification, ERC-8004 on-chain identity, plus AI skill security audits (prompt injection, exfiltration, scope violations), agentic commerce credentials, and market integrity monitoring. 27 tools.
