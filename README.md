...
- [varun369/skillfortify](https://github.com/varun369/skillfortify) 🐍 🏠 - Formal analysis and supply chain security for agent skills. Sound static analysis with five mathematical theorems, SAT-based dependency resolution, trust scoring, and CycloneDX ASBOM generation. Supports Claude Code, MCP, and OpenClaw formats. ([Paper](https://doi.org/10.5281/zenodo.18787663))
