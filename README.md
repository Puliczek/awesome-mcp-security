...
- [bromoket/x64dbg_mcp](https://github.com/bromoket/x64dbg_mcp) 📇 🏠 🪟 - MCP Server for the x64dbg debugger with 23 mega-tools for memory inspection, disassembly, breakpoints, tracing, anti-debug bypasses, control flow analysis, and PE dumping.
